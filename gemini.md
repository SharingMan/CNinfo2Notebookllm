...
- Continuing after something went wrong without re-planning
- Making changes without a clear plan in `tasks/todo.md`
- Marking complete without verification evidence
- Applying a hacky fix when an elegant solution exists
- Asking the user how to fix a bug instead of investigating
- Forgetting to capture lessons after a correction
